...
function Gallary() {
  return (
    <section className='gallary relative'>
      ...
      <div className="wrapper w-full flex justify-center items-center sm:flex-row flex-col pt-6 pb-16 sm:px-16 px-3">
        <div className="gallary-item w-full sm:w-2/10 ">
